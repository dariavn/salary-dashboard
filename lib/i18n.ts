...
const strings = {
  en: {
    ...
    avgAllGrades: 'Average · all grades',
    sourcesAnalyzedNote: 'sources analyzed',
    dataScarceNote: 'Public salary data for this role is limited — see the market note below',
  ...
  ru: {
    ...
    avgAllGrades: 'Среднее по всем грейдам',
    sourcesAnalyzedNote: 'источников проанализировано',
    dataScarceNote: 'Публичных данных по этой роли мало — см. примечание о рынке ниже',
